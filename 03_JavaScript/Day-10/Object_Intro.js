...
//* What is an object ?
    ...
    // The key (property name) is a string (a symbol), and the value can be any type of data, such as a number, string, array, function, or object.


//* Key Characteristics of Objects:
    // 1. Unordered: 
        // Unlike arrays, the properties in an object are unordered. They are accessed using the key (property name) rather than a numeric index.

    // 2. Key-Value Pairs: 
        // Objects store data as key-value pairs. 
        // Keys are also called properties, and the values can be of any data type (strings, numbers, arrays, functions, or even other objects).
...
//* ****************************************************
    ...
    console.log(favCar.undefined);                      // Output -> not defined
    console.log(favCar.null);                           // Output -> assign null


    //* Why are we able to access "undefined" and "null" properties in above example? Even though they are reserved keywords in JavaScript.
    // In JavaScript (and TypeScript), object property keys can be strings or symbols. 
    // Even though undefined and null are reserved keywords in JavaScript, they are treated as string keys when used as property names in an object. 
    // This is why we can access them like any other property.
...
//* ****************************************************
    ...
    // 1. If an object property has special characters (like spaces, dashes, etc.) or starts with a number, dot notation won’t work. 
